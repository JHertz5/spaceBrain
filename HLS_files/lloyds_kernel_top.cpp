...
//void load_centres_buffer(uint offset, uint address, volatile bus_type *bus, centre_index_type k, uint *buffer)
//{
//	bus_type int_buffer[K];
//
//	memcpy(int_buffer, (const bus_type *)(bus + (offset + address)/sizeof(bus_type)), (k+1)*sizeof(bus_type));
//
//	for (centre_index_type i=0; i<=k; i++)
//	{
//		#pragma HLS loop_flatten
